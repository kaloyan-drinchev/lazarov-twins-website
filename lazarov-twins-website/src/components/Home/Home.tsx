    ...
    <div className="home-page">
      ...
      <section className="home-app-download" ref={appSectionRef}>
        <div className="home-app-download-container">
          <div className={`home-app-download-content ${isAppSectionVisible ? 'animate-in' : ''}`}>
            <h2 className="home-app-download-title">Take L-Twins Fitness With You</h2>
            <p className="home-app-download-description">
              Download our mobile app for the ultimate fitness experience. Track your workouts, 
              access programs offline, and stay motivated wherever you are.
            </p>
